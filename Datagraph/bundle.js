(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.datagraph = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
'use strict'
...
var messsage_1 = require("./messsage");
...
function loadPackets() {
    ...
    document.getElementById("endMessage").value = '' + messages.length;
    return messages;
}
...
var myImageData;
function setColorIndicesForCoord(x, y, value) {
    var red = y * (myImageData.width * 4) + x * 4;
    var lookup = value * 4;
...
;
function setColorIndicesForCoordQuad(x, y, value) {
...
function saveState() {
    ...
    localStorage.setItem("data", document.getElementById("traceFile").value);
    localStorage.setItem("data_type", document.getElementById("fileFormat").value);
}
function loadState() {
    var localStorage = window.localStorage;
    document.getElementById("traceFile").value = localStorage.getItem("data") || "";
    document.getElementById("fileFormat").value = localStorage.getItem("data_type") || "";
}
exports.loadState = loadState;
function updateMiniMapPos(event) {
    var x = Math.floor(event.layerX / minimapScale);
    var y = Math.floor(event.layerY / minimapScale);
    var minimappos = document.getElementById("minimappos");
    var message = miniMapMessageLookup[x];
    if (message && (y) < message.getLength() - messsage_1.MessageIndicies.END_LENGTH && y >= messsage_1.MessageIndicies.START_OF_BODY) {
        minimappos.innerText = "Messge type:" + message.getIdHex() + " byte#:" + (y) + " body#:" + ((y) - messsage_1.MessageIndicies.START_OF_BODY) + " value: " + hexFormat(message.buf.readUInt8(y));
    }
    else {
...
function hexFormat(num) {
    var v = num.toString(16).toUpperCase();
    return v.length == 1 ? '0x0' + v : '0x' + v;
}
var colorMap;
function loadColorMap() {
    var colorOption = document.getElementsByClassName("colorMapOption")[0].value;
    switch (colorOption) {
        case "0":
...
var miniMapMessageLookup = [];
function drawMiniMap() {
    loadColorMap();
    var width = 800;
    var height = 256;
    var canvas = document.getElementById("messageOverTime");
    ...
    var filtered = document.getElementById("filtered").checked;
    var messageTypeInputValue = document.getElementsByClassName("messageType")[0].value;
    ...
    if (ctx) {
        ...
        var posx = 0;
        for (var i = start; i < exports.messages.length && i < end && posx < 800; i++) {
            var msg = exports.messages[i];
            if (filtered && msg.getId() !== messageType) {
                continue;
            }
            miniMapMessageLookup[posx] = msg;
            for (var j = messsage_1.MessageIndicies.START_OF_BODY; j < msg.buf.length - messsage_1.MessageIndicies.END_LENGTH; j++) {
...
function graph() {
    ...
    for (var j = 0; j < filters.length; j++) {
        ...
        var messageTypeInputValue = filter.getElementsByClassName("messageType")[0].value;
        if (messageTypeInputValue === '') {
            continue;
        }
        var messageType = parseInt(messageTypeInputValue, 16);
        var byteOffset = parseInt(filter.getElementsByClassName("byteOffset")[0]
            .value, 10) + messsage_1.MessageIndicies.START_OF_BODY;
    ...
    if (chart === undefined) {
        ...
        chart_js_1.Chart.defaults.global.animation.duration = 0;
...
function playByte(byteNum) {
    if (byteNum === undefined) {
        byteNum = parseInt(document.getElementsByClassName("lineFilter")[0].getElementsByClassName("byteOffset")[0]
            .value, 10);
    }
    // create 2 second worth of audio buffer, with single channels and sampling rate of your device.
    var sampleRate = audioContext.sampleRate;
...
var MessageIndicies = /** @class */ (function () {
    function MessageIndicies() {
    }
    MessageIndicies.START_OF_MESSAGE = 0;
    MessageIndicies.MESSAGE_LENGTH = 1;
    MessageIndicies.MESSAGE_CLASS = 3;
    MessageIndicies.SEQ_NUMBER = 4;
    MessageIndicies.MESSAGE_TYPE = 5;
    MessageIndicies.START_OF_BODY = 6;
    MessageIndicies.END_LENGTH = 3; // checksum and the EOM
    return MessageIndicies;
}());
...
var SonyMessage = /** @class */ (function () {
    ...
    SonyMessage.prototype.getIdHex = function () {
...
exports.SonyMessage = SonyMessage;
